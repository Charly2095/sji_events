...
<body>
    <form name="search" method="Post" style="padding-left: 650;">
...
?>
        <div class="mySlides fade">
            <img src="/sji_events/images/<?= $ary['image']?>" style="width:100%; height:300;">
            <div class="text">
               <b style="color:red;"> <?= $ary['ename']?> </b>
            </div>
        </div>
        <?php
    }
...
$count1=mysqli_num_rows($result);
	...
	?>
            <tr>
                <td><img src="/sji_events/images/<?=$rec['image']?>" height="200" width="200"></td>
                <td>
                    <?= $rec['ename'] ?><br>
                    <?=$rec['cname']?>
                </td>
                <td><a href="/sji_events/event/details.php?id=<?=$rec['eid']?>">Details</a></td>
            </tr>
            <?php	}
    }
	?>
